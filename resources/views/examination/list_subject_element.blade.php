        ...
        @if(!empty($subject))
            @foreach($subject as $key => $row)
                <tr>
                    ...
                    <td>
                        <a href="{!! url('/teacher/add_eam_form/'.$row->id_subject) !!}"><button class="btn btn-warning mt-2 mt-xl-0 text-right"><i class="mdi mdi-format-list-bulleted-type"></i></button></a>
