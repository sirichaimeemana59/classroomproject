...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="panel panel-default" id="panel-lead-list">
                        ...
                        <div class="panel-body" id="landing-student-list">
                            @include('student_admin.list_student_element')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Modal add teacher-->
    <div class="modal fade" id="add-student-form" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #9BA2AB;">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" style="color: #bbbfc3;">{!! trans('messages.student.list_student') !!}</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form">
                                {!! Form::model(null,array('url' => array('admin/insert_student'),'class'=>'form-horizontal','id'=>'form_add','method'=>'post','enctype'=>'multipart/form-data')) !!}
    ...
    <!-- Modal edit teacher-->
    <div class="modal fade" id="edit-student" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #9BA2AB;">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
            ...
            $('.view-student').on('click',function(){
                ...
                $.ajax({
                    ...
                    success : function(e){
                        ...
                        console.log('Error View Data Student');
                    }
                });
            });
