{!! Form::model($student,array('url' => array('admin/insert_teacher'),'class'=>'form-horizontal','id'=>'form_add','method'=>'post','enctype'=>'multipart/form-data')) !!}
...
<div class="form-group row">
    ...
    <div class="col-sm-4">
        {!! Form::text('name_student',null,array('class'=>'form-control','placeholder'=>trans('messages.teacher.name'),'required','readonly')) !!}
    </div>

    <lable class="col-sm-2 control-label">{!! trans('messages.teacher.last_name') !!}</lable>
    <div class="col-sm-4">
        {!! Form::text('lastname_student',null,array('class'=>'form-control','placeholder'=>trans('messages.teacher.last_name'),'required','readonly')) !!}
    </div>
</div>
