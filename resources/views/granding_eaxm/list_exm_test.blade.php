                            ...
                            @foreach($examination as $key => $row)
                                ...
                                @foreach($row->join_examination_transection as $key_ => $row_)
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <span><input type="checkbox" name="data[{!! $key !!}][ans]" value="{!! $row_->id !!}" @if($answer_student[$key]['id_ans'] == $row_->id) checked @endif></span>
                                    ...
                                    @if($answer_student[$key]['id_ans'] == $row_->id) <?php $i++;?> @endif
                                @endforeach
                            @endforeach
Total{!!$i!!}
