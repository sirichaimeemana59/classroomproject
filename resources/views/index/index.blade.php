...
<head>
    ...
    <link rel="stylesheet" href="{!! url('/') !!}/vendors_index/popup/magnific-popup.css">
...
<div class="side_menu">
    <ul class="list menu_right">
        <li>
            <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal-login">Login</button>
            {{--<button type="button" class="btn btn-info btn-sm modal-login" data-toggle="modal">Login</button>--}}
        </li>
        <li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    {!! Form::model(null,array('url' => array('user/login'),'class'=>'form-horizontal','id'=>'form_add','method'=>'post','enctype'=>'multipart/form-data')) !!}
                        <div class="form-group">
                            <label for="email">Email:</label>
                            {!! Form::email('email',null,array('class'=>'form-control','placeholder'=>'Enter email','required','id','email')) !!}
                        </div>
                        <div class="form-group">
