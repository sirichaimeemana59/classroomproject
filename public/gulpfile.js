...
gulp.task('injectCommonAssets', function () {
  return gulp.src('./**/*.html')
    .pipe(inject(gulp.src([ 
        './vendors/mdi/css_layout/materialdesignicons.min.css',
...
gulp.task('buildBaseVendorStyles', function() {
    return gulp.src(['./node_modules/perfect-scrollbar/css_layout/perfect-scrollbar.css'])
...
gulp.task('copyRecursiveVendorFiles', function() {
    ...
    gulp.src(['./node_modules/datatables.net-bs4/css_layout/dataTables.bootstrap4.css'])
        .pipe(gulp.dest('./vendors/datatables.net-bs4'));
    gulp.src(['./node_modules/@mdi/font/css_layout/materialdesignicons.min.css'])
        .pipe(gulp.dest('./vendors/mdi/css_layout'));
